...
# http://docs.djangoproject.com/en/1.5/ref/settings/#secure-proxy-ssl-header
...
# See: http://wiki.openstack.org/wiki/Horizon/RESTAPI
...
CUSTOM_THEME_PATH="themes/m1"

COMPRESS_OFFLINE=False

OPENSTACK_KEYSTONE_DEFAULT_ROLE="Member"

OPENSTACK_HOST="192.168.122.230"

OPENSTACK_KEYSTONE_URL="http://192.168.122.230:5000/v2.0"

# NephoScale options
ADMIN_AUTH_URL = 'http://192.168.122.230/v2.0'
ADMIN_USERNAME = 'admin'
ADMIN_PASSWORD = 'admin'
ADMIN_TENANT = 'admin'
ADMIN_DOMAIN = 'default'
ADMIN_REGION = 'RegionOne'

BILLING_ROLE = 'billing'
BILLING_ADMIN_ROLE = 'billing-admin'

CIPHER_KEY = '749dd86f607fa53a5890bb8a0f790474'

#SIGNUP_BRAND_ID = 'm1'
SIGNUP_ROLES = ['admin', 'signup-admin']
SIGNUP_CONTACT_EXTRA_LABEL = 'Account extra data'

# Astute Billing config
ASTUTE_BASE_URL = 'http://69.50.235.228:9080/v1/'
...
ADMIN_PASSWORD='admin'
ADMIN_TENANT='admin'
ADMIN_AUTH_URL="http://192.168.122.230:5000/v2.0"
ADMIN_REGION='stage1'

# zendesk specifics
ZENDESKSUPPORT_ENABLED   = True
ZENDESK_ADMIN_EMAIL      = 'alan@nephoscale.com'
ZENDESK_ADMIN_PASSWORD   = 'ath3naw1zd0m'
...
#Keystone V3 connection for Zendesk
